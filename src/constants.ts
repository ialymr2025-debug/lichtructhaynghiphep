export const DEFAULT_STAFF = [
  ...
  ["Trực phụ máy",     "Phạm Văn Von",       "Thái Trần Hoàng Vũ", "Lê Văn Tích",       null,"Puih Thăn"],
  ...
  ["Trực phụ cơ MR",   "Nguyễn Quang Minh",  "Rmah Thắng",         "Phạm Thanh Tùng",   "Nguyễn Văn Trung",   null]
];
